...
4. schrijft altijd een nieuwe `.env` met jouw token/user id (en toont het exacte pad), ook als latere install-stappen falen.
...
Installeer daarna Ollama handmatig via de officiële macOS installer. Controleer daarna meteen: `cat .env`.
